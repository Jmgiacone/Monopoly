...
//    }
    ...
    {
        board[39] = new Space("Go", new Point2D.Double(10,10), Bank.PASS_GO_AMOUNT);
        board[38] = new Property(
                "Mediterranean Avenue", 60, 2, 10, 30, 90, 160, 250, new Point2D.Double(10,10));
        board[37] = new Space("Community Chest", new Point2D.Double(10,10), 0);
        board[36] = new Property(
                "Baltic Avenue", 60, 4, 20, 60, 180, 320, 450, new Point2D.Double(10,10));
        board[35] = new Space("Income Tax", new Point2D.Double(10,10), 0);
        ...
        board[32] = new RailRoad("Reading Railroad", 200, new Point2D.Double(10,10));
        ...
        board[29] = new Space("Jail", new Point2D.Double(10,10), 0);
        ...
        board[22] = new Space("Community Chest", new Point2D.Double(10,10), 0);
        ...
        board[19] = new Space("Free Parking", new Point2D.Double(10,10), 0);
        board[18] = new Property(
                "Kentucky Avenue", 220, 18, 90, 250, 700, 875, 1050, new Point2D.Double(10,10));
        board[17] = new Space("Chance", new Point2D.Double(10,10), 0);
        ...
        board[9] = new Space("Go to Jail", new Point2D.Double(10,10), 0);
        ...
        board[6] = new Space("Community Chest", new Point2D.Double(10,10), 0);
        ...
        board[3] = new Space("Chance", new Point2D.Double(10,10), 0);
        board[2] = new Property(
                "Park Place", 350, 35, 175, 500, 1100, 1300, 1500, new Point2D.Double(10,10));
        board[1] = new Space("Luxury Tax", new Point2D.Double(10,10), -75);
